    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link" target="blank" rel='noopener' href="{{env('FIGMA_TWITTER')}}"><span class="fab fa-twitter"></span> Twitter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"  target="blank" rel='noopener' href="{{env('FIGMA_DRIBBBLE')}}"><span class="fab fa-dribbble"></span> Dribbble</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"  target="blank" rel='noopener' href="{{env('FIGMA_INSTAGRAM')}}"><span class="fab fa-instagram"></span> Instagram</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" target="blank" rel='noopener' href="{{env('FIGMA_MEDIUM')}}"><span class="fab fa-medium-m"></span> Medium</a>
                </li>
            </ul>
        </div>
    </div>
